                ...
                <div className="flex max-w-screen-xl lg:flex-row flex-col lg:gap-0 gap-11 pb-28">
                    ...
                    <div className="w-full lg:w-3/5">
                        <motion.p
                            ...
                            onMouseLeave={() => props.mouseEnterHandler(40, "white", "normal")}>
                            I'm Rayhan, an enthusiast in data science and AI with a strong interest in transforming data into practical solutions. My work spans a range of challenges, from training XGboost models to categorize obesity based on health metrics, to applying TROCR to read doctor's handwriting, and building LSTMs for forecasting sales, pricing, and air quality.
                            I focus not only on model performance but also on efficiency — exploring techniques like data augmentation, precision trade-offs, and lightweight architectures to create solutions that are both effective and scalable. For me, AI is about blending technical skill with creativity to uncover insights and solve real-world problems.
                        </motion.p>
                    </div>
                </div>
            </div>
