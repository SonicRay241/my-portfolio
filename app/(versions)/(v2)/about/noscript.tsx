    ...
    <div className="p-4">
      ...
      <div className="flex justify-center w-full">
        <div className="flex flex-col items-center w-full text-zinc-300 max-w-screen-md pt-16">
          <h1 className="text-4xl font-medium min-w-full mb-6">
            About
          </h1>
          ...
          <ItemList
            name="rayhan.permana@outlook.com"
            type="Email Address"
            url="mailto:rayhan.permana@outlook.com"
          />
          <ItemList
            name="linkedin.com/in/rayhan-permana-733129292/"
            type="LinkedIn"
          ...
          <div className="w-full mt-12">
            <Link className="group flex justify-start items-center w-fit py-2" href="/">
              <h3 className="text-xl text-zinc-100 group-hover:text-violet-600 transition-colors">Home</h3>
            </Link>
          </div>
        </div>
      </div>
...
function ItemList(props: {
  ...
  return (
    <Link className="group flex justify-between items-center min-w-full py-2" href={props.url} target="_blank" rel="noreferrer">
